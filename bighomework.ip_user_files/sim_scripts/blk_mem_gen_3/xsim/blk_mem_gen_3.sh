...
#
# Generated by Vivado on Sun Dec 24 15:17:09 +0800 2023
...
# Script info
echo -e "blk_mem_gen_3.sh - Script generated by export_simulation (Vivado v2018.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L blk_mem_gen_v8_4_1 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot blk_mem_gen_3 xil_defaultlib.blk_mem_gen_3 xil_defaultlib.glbl -log elaborate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb blk_mem_gen_3.wdb xsim.dir)
