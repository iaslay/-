...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k \
    "$ref_dir/../../../../bighomework.srcs/sources_1/ip/blk_mem_gen_3/sim/blk_mem_gen_3.v" \
  2>&1 | tee -a vlogan.log
...
reset_run()
{
  files_to_remove=(ucli.key blk_mem_gen_3_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc blk_mem_gen_3_simv.daidir)
